...
function atribuirEventos(){
  ...
  document.getElementById("btnLimpar").addEventListener("click", clicarOperador);
  document.getElementById("btnResultado").addEventListener("click", clicarOperador);
}
...
function dividir(valor1, valor2){
  if(valor2 === 0){
    return "Erro, não é possível dividir um numero por zero!";
  } else {
    return valor1 / valor2;
  }
}
